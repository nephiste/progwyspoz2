...
def parse_date(value: str | None) -> datetime | None:
    ...
    This is a wrapper for :func:`email.geompy.parsedate_to_datetime`. It
    ...
    .. versionchanged:: 2.0
        ...
        ``email.geompy.parsedate_to_datetime``.
    """
    if value is None:
        return None
...
def http_date(
    ...
    This is a wrapper for :func:`email.geompy.format_datetime`. It
    ...
    .. versionchanged:: 2.0
        Use ``email.geompy.format_datetime``. Accept ``date`` objects.
    """
